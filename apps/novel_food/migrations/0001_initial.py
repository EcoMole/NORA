# Generated by Django 4.2.13 on 2024-06-24 08:19
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        help_text="explanation in case the Novel Food has a "
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        help_text="explanation in case the Outcome is 'Negative' or "
                        "'Partially Negative'",
                        null=True,
                    ),
                ),
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        help_text="if novel food has specific toxicity, specify "
                        "which one. (TOXICITY vocab)",
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        help_text="If missing in vocabulary, move on, do not add into "
                        "vocab. (PARAM vocab)",
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "id",
                    models.AutoField(
                        db_column="id_sci_name", primary_key=True, serialize=False
                    ),
                ),
                ("title", models.CharField(max_length=255, unique=True)),
                (
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        "applies only if the organism is a microorganism. (YESNO vocab)",
                        limit_choices_to={"taxonomy__code": "YESNO"},
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "value",
                    models.CharField(
                        help_text="contains e.g. the molecular formula itself if type "
                        "is 'Molecular Formula', etc.",
                        max_length=255,
