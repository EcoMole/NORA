        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "id",
                    models.AutoField(
                        db_column="id_type", primary_key=True, serialize=False
                    ),
                ),
                ("title", models.CharField(max_length=255, unique=True)),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        blank=True,
                        help_text="Was the organism genetically modified? or in case of "
                        "cell culture, was the cell culture modified? (YESNO vocab)",
                        limit_choices_to={"taxonomy__code": "YESNO"},
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
