            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        blank=True,
                        db_column="age",
                        help_text="If possible, specify the population info from this vocabulary. "
                        "In case granularity in this field is not sufficient, use the other "
                        "fields to specify the population. (POP_SUBGROUP vocab)",
