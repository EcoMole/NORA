...
class Endpointstudy(models.Model):
    ...
    test_type = models.ForeignKey(
        ...
        limit_choices_to=models.Q(taxonomy__code="TEST_TYPE")
    ...
    guideline = models.ForeignKey(
        ...
        limit_choices_to=models.Q(taxonomy__code="STUDYGUIDELINE")
        & ~models.Q(short_name="root")
        & ~models.Q(status=TaxonomyNode.STATUS.DEPRECATED),
...
class Endpoint(models.Model):
    ...
    subpopulation = models.ForeignKey(
        ...
        & (
            models.Q(is_gender=True)
            | models.Q(extended_name="Fetus / stillbirth / neonatus (as part-nature)")
        )
        & ~models.Q(status=TaxonomyNode.STATUS.DEPRECATED),
...
class ADMEInvestigationType(models.Model):
    ...
    investigation_type = models.ForeignKey(
        InvestigationType, db_column="id_investigation_type", on_delete=models.PROTECT
    )
...
class Genotox(models.Model):
    ...
    outcome = models.ForeignKey(
        ...
        blank=True,
        on_delete=models.PROTECT,
        limit_choices_to=models.Q(taxonomy__code="POSNEG")
        & ~models.Q(short_name="root")
        & ~models.Q(status=TaxonomyNode.STATUS.DEPRECATED),
